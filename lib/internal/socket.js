...
class Socket extends EventEmitter {
  ...
  async _destroy(name, closer) {
    return new Promise((resolve, reject) => {
      let onClose, onError;

      const cleanup = () => {
        this._port.removeListener(name, onClose);
...
class ThreadBase extends Socket {
  ...
  async close() {
    ...
    return this._destroy('exit', () => this._port.terminate());
  }
...
class Port extends Socket {
  ...
  async close() {
    ...
    return this._destroy('close', () => this._port.close());
  }
