...
const isolateOptions = new Set([
  // Debug Options
  // https://github.com/nodejs/node/blob/master/src/node_options.cc#L114
  '--debug',
  '--debug-port',
  '--debug-brk',
  '--inspect',
  ...
  // Environment Options
  // https://github.com/nodejs/node/blob/master/src/node_options.cc#L150
  ...
  // Per Isolate Options
  // https://github.com/nodejs/node/blob/master/src/node_options.cc#L287
  '--track-heap-objects',
