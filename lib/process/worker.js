...
const {setupRefs, toBuffer} = require('../internal/util');
...
function pipeWithoutWarning(source, dest) {
  const sourceMaxListeners = source.getMaxListeners();
  const destMaxListeners = dest.getMaxListeners();
  ...
  try {
    ...
    source.setMaxListeners(sourceMaxListeners);
    dest.setMaxListeners(destMaxListeners);
  }
}
