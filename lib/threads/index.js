...
if (threads.parentPort) {
  threads.parentPort.exit = process.exit;
  threads.parentPort.stdin = process.stdin;
  threads.parentPort.stdout = process.stdout;
  threads.parentPort.stderr = process.stderr;
  threads.parentPort.console = process.console;
}
