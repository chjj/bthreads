...
const HEADER_URL = 'https://unpkg.com/bthreads-bundle@0.0.3/index.js';
...
class Worker extends EventEmitter {
  ...
  _init(file, options) {
    ...
    if (options.stdout) {
      this._stdio[1] = new stdio.Readable(this, 1);
      once(this._stdio[1], 'data', () => this._bind());
    }

    if (options.stderr) {
      this._stdio[2] = new stdio.Readable(this, 2);
      once(this._stdio[2], 'data', () => this._bind());
    }
