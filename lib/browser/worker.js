...
const DEFAULT_BOOTSTRAP_URL =
  'https://unpkg.com/bthreads-bundle@0.4.2/index.js';
...
class Worker extends EventEmitter {
  ...
  _init(file, options) {
    ...
    if (file != null) {
      ...
      if (file.startsWith(INLINE_PREFIX.length)) {
        environment = Object.assign(Object.create(null), environment, {
          BTHREADS_WORKER_INLINE: file.substring(INLINE_PREFIX.length)
        });
    ...
    this._worker = new backend.Worker(url, {
      ...
      name: JSON.stringify([
        ...
        options.eval ? options.dirname : null,
