...
const nullWrite = new stdio.NullWritable();
...
class Parent extends MessagePortBase {
  ...
  _init() {
    ...
    if (WORKER_STDIN) {
      this._stdio[0] = new stdio.Readable(this, 0);
      this._bind();
    }
...
function parseEnv(name) {
  ...
  return {
    ...
    WORKER_STDOUT: items[3],
    WORKER_STDERR: items[4],
    WORKER_EVAL: items[5]
  };
}
